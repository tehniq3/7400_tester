 ...
 * based on OR (7432 / 74LS32) tester by Nicu FLORICA (niq_ro)
 * v.0 - intial version
...
byte test[] = {  // https://www.build-electronic-circuits.com/7400-series-integrated-circuits/74hc00-74ls00/
0, 0, 1,
1, 0, 1,
0, 1, 1,
1, 1, 0
...
void setup() {
  Serial.begin(9600);
  Serial.println("-");
  Serial.println("NAND gates teter (74LS00 / 7400 tester"); 
  Serial.println("------------------------------------"); 
  for (int i = 0; i < 4; i++) 
  {
